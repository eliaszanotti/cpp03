...
/*   Updated: 2023/05/16 19:02:46 by elias            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
	...
	std::cout << "\e[32m[INFO] " << this->_name << " created.\e[0m" << std::endl;
}
...
{
	*this = copy;
	std::cout << "\e[32m[INFO] " << copy._name << " copied.\e[0m" << std::endl;
}

ClapTrap::~ClapTrap()
{
	std::cout << "\e[31m[INFO] " << this->_name << " destroyed.\e[0m" << std::endl;
}
